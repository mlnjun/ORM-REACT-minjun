    ...
    <React.Fragment>
      <div className="user-chat w-100 overflow-hidden">
        <div className="d-lg-flex">
          <div
            className={
              props.userSidebar ? 'w-70 overflow-hidden position-relative' : 'w-100 overflow-hidden position-relative'
            }
          >
            {/* render user head */}
            <UserHead users={props.recentChatList} active_user={props.active_user} />
                      ...
                      <div className="conversation-list">
                        ...
                        <div className="user-chat-content">
                          ...
                          {chatMessages[key + 1] ? (
                            ...
                            <div className="conversation-name">
                              {chat.userType === 'sender' ? 'Admin' : props.recentChatList[props.active_user].name}
                            </div>
                          )}
                        </div>
                      </div>
