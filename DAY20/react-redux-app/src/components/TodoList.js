...
// redux 전역데이터 공간에 데이터를 반영하려면 useDispatch라는 훅을 참조합니다.
import { useDispatch } from 'react-redux'

// redux 전역공간에 데이터를 반영하려면 반드시 액션함수를 참조해야합니다.
// redux 폴더안에 액션통합모듈을 참조하고 관련 액션함수를 참조합니다.
...
const TodoList = () => {
  ...
  return (
    <div>
      할일 : <input name="title" value={todo.title} onChange={handleTodo} /> <br />
      우선 순위 : <input name="orderby" value={todo.orderby} onChange={handleTodo} /> <br />
