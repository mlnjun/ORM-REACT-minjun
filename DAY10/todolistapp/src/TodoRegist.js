  ...
  return (
    <div>
      <form onSubmit={onSubmit}>
        제목:
        <input name="text" value={todo.text} onChange={onTodoChange} placeholder="할 일" />
        내용:
        <input name="desc" value={todo.desc} onChange={onTodoChange} placeholder="내용" />
